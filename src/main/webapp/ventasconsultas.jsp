		...
		<div>
			...
			<table class="tablaventas1">
				<tr>
					...
					<td>
						<input type="submit" name="btnConsultarClientes" id="btnConsultarClientes" value="Consultar" class="button">
					</td>
					<td>
						<label>Cliente</label>
					</td>
			...
			<table class="tablaventas2">
				...
				<tr>
					...
					<td>
						<input type="text" name="txtNomProd1" id="txtNomProd1" maxlength="50" size="30" disabled value=<%=txtNomProd1%>>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="txtNomProd2" id="txtNomProd2" maxlength="50" size="30" disabled value=<%=txtNomProd2%>>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="txtNomProd3" id="txtNomProd3" maxlength="50" size="30" disabled value=<%=txtNomProd3%>>
					</td>
					<td>
