...
<html>
	...
	<body>
		...
		<div>
			...
			<center>
		      <table border = "0">
		        <tr><td><label>Codigo del Producto </label></td>
				    <td><input type="number" name="txtCodigo" id="txtCodigo" maxlength="20" size ="50"></td>

					<td><label>IVA</label></td>
					<td><input type="number" name="txtIVA" id="txtIVA" maxlength="50" size ="50" placeholder="Digite el IVA"></td>
				</tr>
				<tr>
					<td><label>Nombre del Producto </label></td>
					<td><input type="text" name="txtNombre" id="txtNombre" maxlength="50" size ="50" placeholder="Digite el nombre"></td>
 	
 		            <td><label>Valor Compra </label></td>
					<td><input type="number" name="txtValorCompra" id="txtValorCompra" maxlength="50" size ="50" placeholder="Digite el valor"></td>
				</tr>
		        <tr>
		        	<td><label>NIT Proveedor </label></td>
					<td><input type="number" name="txtNIT" id="txtNIT" maxlength="50" size ="50" placeholder="NIT Proveedor"></td>
					
					
					<td><label>Valor Venta </label></td>
					<td><input type="number" name="txtValorVenta" id="txtValorVenta" maxlength="50" size ="50" placeholder="Digite el valor"></td>
		        </tr>
		        </tr>
